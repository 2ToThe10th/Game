...
// AplicationPart : public SystemPart
// порождает силы, применяет к игрокам
// анимация
// хормен и костлер (2 тома) для изучения java

// cv
// имя фамилия, телефон, где учишься
// фотка
// кто, где учился, достижения олимпиады
// курсы которые есть на фивте + КБ + ссылки на программу
// проекты с ссылками, сделать норм репозитории, начиная с самых последних
// google doc
